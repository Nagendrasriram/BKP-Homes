      ...
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <div className="grid grid-cols-12 gap-12 items-center">
          ...
          <motion.div 
            ...
            className="col-span-12 lg:col-span-6 relative h-[450px] md:h-[550px] rounded-2xl overflow-hidden border border-white/10 shadow-2xl"
          >
            <Image
            ...
            {/* Info Badge */}
            <div className="absolute bottom-6 left-6 right-6 p-6 rounded-xl glassmorphism border border-white/5 flex items-center justify-between">
              <div>
                <p className="text-xs uppercase tracking-widest text-luxury-gold font-semibold">Live Factory Tour</p>
                <p className="text-[11px] text-luxury-beige/80 font-light mt-0.5">Visit our factory in Hyderabad to witness your furniture being built.</p>
              </div>
              <a 
                href="#contact" 
